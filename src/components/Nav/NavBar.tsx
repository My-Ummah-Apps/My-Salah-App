...
const NavBar = () => {
  ...
  return (
    <div className="fixed left-0 h-[10vh] bottom-0 z-10 flex items-center justify-around w-full bg-[var(--primary-color)] navbar-wrap pb-env-safe-area-inset-bottom">
