  ...
  return (
    ...
    >
      ...
      {showLocationDetailsInput && (
        <section className="flex flex-col items-center justify-center w-4/5 absolute z-10 -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2  rounded-lg max-w-[300px]">
      ...
      <section className="px-2 mx-5 mb-4 text-sm text-center">
        <p>
          To calculate Salah times, the app requires your location, you can use
          one of the three methods below. <br></br>
